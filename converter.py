...
class TranslateConverter(PDFConverterEx):
    def __init__(
        ...
        # Kiểm tra nếu service đã có dấu hai chấm ở cuối
        if service.endswith(':') and service.count(':') == 1:
            # Nếu service có định dạng "Google:", cắt bỏ dấu hai chấm cuối cùng
            service_name = service[:-1]
            service_model = None
        else:
            # Xử lý case thông thường như trước
    ...
    def receive_layout(self, ltpage: LTPage):
        ...
        LANG_LINEHEIGHT_MAP = {
            ...
            "ja": 1.1, "ko": 1.2, "en": 1.2, "ar": 1.0, "ru": 0.8, "uk": 0.8, "ta": 0.8, "vi": 1.2
        }
